        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl shadow hover:shadow-blue-500/20 transition-shadow duration-300">
                <h3 className="text-xl font-bold text-white mb-3 flex justify-center items-center mt-4 gap-3">A4 Class Survey 
                    <a href="#" target="_blank" rel="noopener noreferrer" className="text-black-400 hover:text-white-300 transition-colors" aria-label="View on GitHub"
                    >
