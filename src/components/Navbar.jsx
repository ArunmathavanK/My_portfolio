        ...
        <div className="max-w-5xl mx-auto px-4">
            <div className="flex justify-between items-center h-16">
                ...
                <div className="hidden md:flex items-centre space-x-8">
                    <a href="#home" className="text-white font-bold hove:text-white transition-colors">{" "}Home{" "}</a>
                    <a href="#about" className="text-white font-bold hove:text-white transition-colors">{" "}About{" "}</a>
                    <a href="#projects" className="text-white font-bold hove:text-white transition-colors">{" "}Projects{" "}</a>
                    <a href="#contact" className="text-white font-bold hove:text-white transition-colors">{" "}Contact{" "}</a>
                </div>
            </div>
        </div>
    </nav>
